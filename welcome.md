...
- **Want your final project reviewed and verified?** Join **Exam Navigator** as a channel member: [become a member](https://www.youtube.com/channel/UCMf7pje1x5iZkkEF-Y3PLSA/join). Full details are on the [Get Help & Get Verified](support-and-verification.md) page.

## Your path from here

Follow these in order — each step assumes the one before it:

1. **[Course Overview](README.md)** — the big picture and the full course map.
2. **[Course Objectives](objectives.md)** — exactly what you will be able to do, and who this is for.
3. **[Course Syllabus](syllabus.md)** — the complete curriculum, module by module.
4. **[How to Use This Course](how-to-use.md)** — the learning loop, the pace, and how each page is laid out.
5. **[Module 0 · Getting Started & Your PDI](module-0-getting-started/README.md)** — orientation, then create and configure your free instance **before you write any code**.

{% hint style="warning" %}
**Do not skip Module 0.** Every exercise from Module 1 onward runs in your own PDI. Set it up first — [create your PDI](module-0-getting-started/02-create-your-pdi.md), then [configure it](module-0-getting-started/03-configure-your-pdi.md) — and the rest of the course just works.
{% endhint %}
